...
namespace LibSerial 
{
	...
	//std::cout << "file descriptor is " << this->mFileDescriptor<< std::endl;
            ...
            number_of_bytes_available > 0)
        {
            ...
            std::cout << "ready ok ! number of bytes available : "<< number_of_bytes_available << " io control:"<< ioctl_result << std::endl;
        }
